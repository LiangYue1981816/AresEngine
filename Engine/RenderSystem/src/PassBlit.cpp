	...
	, m_pRenderQueue(nullptr)
{
	...
	m_ptrMeshDraw = GfxRenderer()->NewMeshDraw(HashValueFormat("%s.MeshDraw", szMaterialFileName), m_ptrMesh, 0, INSTANCE_FORMAT, 1);
	...
	m_pRenderQueue->Add(m_ptrMaterial, m_ptrMeshDraw, RenderSystem()->GetPostProcessInstnaceIndex());
	m_pRenderQueue->End();
}
