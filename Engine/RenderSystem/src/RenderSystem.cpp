	...
	, m_pPassFinal(nullptr)
{
	...
	Settings()->SetValue("RenderSystem.AutoExposure.Lower", 0.05f);
	Settings()->SetValue("RenderSystem.AutoExposure.Upper", 0.95f);
	Settings()->SetValue("RenderSystem.AutoExposure.Luminance", 0.50f);
}
...
void CRenderSystem::CreatePasses(void)
{
	...
	CPassAutoExposure::Create(GFX_PIXELFORMAT_RGBA16_SFLOAT_PACK16);
...
//	CreateRenderTexture(RENDER_TEXTURE_GBUFFER3, GFX_PIXELFORMAT_RGBA8_UNORM_PACK8, GfxRenderer()->GetSwapChain()->GetWidth(), GfxRenderer()->GetSwapChain()->GetHeight());
	...
	CreateRenderTexture(RENDER_TEXTURE_HISTOGRAM_HDR_COLOR0, GFX_PIXELFORMAT_RGBA16_SFLOAT_PACK16, HISTOGRAM_TEXTURE_WIDTH, HISTOGRAM_TEXTURE_HEIGHT);
	CreateRenderTexture(RENDER_TEXTURE_HISTOGRAM_HDR_COLOR1, GFX_PIXELFORMAT_RGBA16_SFLOAT_PACK16, HISTOGRAM_TEXTURE_WIDTH, HISTOGRAM_TEXTURE_HEIGHT);
	CreateRenderTexture(RENDER_TEXTURE_HISTOGRAM_HDR_COLOR2, GFX_PIXELFORMAT_RGBA16_SFLOAT_PACK16, HISTOGRAM_TEXTURE_WIDTH, HISTOGRAM_TEXTURE_HEIGHT);
}
