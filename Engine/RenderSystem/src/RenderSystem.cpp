...
void CRenderSystem::CreateRenderTexture(void)
{
	...
	m_ptrRenderTextures[RENDER_TEXTURE_SHADOWMAP_DEPTH]->Create(GFX_PIXELFORMAT_D32_SFLOAT_PACK32, 4096, 4096);
	m_ptrRenderTextures[RENDER_TEXTURE_SHADOWMAP_COLOR]->Create(GFX_PIXELFORMAT_BGRA8_UNORM_PACK8, 4096, 4096);
	m_ptrRenderTextures[RENDER_TEXTURE_SHADOWMAP_COLOR_BLUR]->Create(GFX_PIXELFORMAT_BGRA8_UNORM_PACK8, 4096, 4096);
}
