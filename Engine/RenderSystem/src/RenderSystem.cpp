...
static const ATTRIBUTE vertexAttributes[VERTEX_ATTRIBUTE_COUNT] = {
	...
	{ VERTEX_ATTRIBUTE_NORMAL,    1, 3, GFX_DATA_SINT8,   GFX_PIXELFORMAT_RGB8_SNORM_PACK8,    TRUE,  "inNormal"    },
	{ VERTEX_ATTRIBUTE_BINORMAL,  2, 4, GFX_DATA_SINT8,   GFX_PIXELFORMAT_RGBA8_SNORM_PACK8,   TRUE,  "inBinormal"  },
	{ VERTEX_ATTRIBUTE_COLOR,     3, 3, GFX_DATA_UINT8,   GFX_PIXELFORMAT_RGB8_UNORM_PACK8,    TRUE,  "inColor"     },
...
void CRenderSystem::CreatePasses(void)
{
	...
	CPassTileDeferredShading::Create(GFX_PIXELFORMAT_BGR10A2_UNORM_PACK32, GFX_PIXELFORMAT_D32_SFLOAT_PACK32);
