...
static const ATTRIBUTE vertexAttributes[VERTEX_ATTRIBUTE_COUNT] = {
	{ VERTEX_ATTRIBUTE_POSITION,  4, 3, 0, GFX_PIXELFORMAT_RGB32_SFLOAT_PACK32, "inPosition"  },
	{ VERTEX_ATTRIBUTE_NORMAL,    1, 3, 1, GFX_PIXELFORMAT_RGB8_SNORM_PACK8,    "inNormal"    },
	{ VERTEX_ATTRIBUTE_BINORMAL,  1, 4, 2, GFX_PIXELFORMAT_RGBA8_SNORM_PACK8,   "inBinormal"  },
	{ VERTEX_ATTRIBUTE_COLOR,     1, 3, 3, GFX_PIXELFORMAT_RGB8_UNORM_PACK8,    "inColor"     },
	{ VERTEX_ATTRIBUTE_TEXCOORD0, 4, 2, 4, GFX_PIXELFORMAT_RG32_SFLOAT_PACK32,  "inTexcoord0" },
	{ VERTEX_ATTRIBUTE_TEXCOORD1, 4, 2, 5, GFX_PIXELFORMAT_RG32_SFLOAT_PACK32,  "inTexcoord1" },
};

static const ATTRIBUTE instanceAttributes[INSTANCE_ATTRIBUTE_COUNT] = {
	{ INSTANCE_ATTRIBUTE_INDEX, 4, 1, 8,  GFX_PIXELFORMAT_R32_SINT_PACK32, "inInstanceIndex" },
};
