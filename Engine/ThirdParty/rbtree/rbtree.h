...
#define rb_set_parent(rb, p) do { (rb)->rb_parent_color = ((rb)->rb_parent_color & 3) | (unsigned long long)(p); } while (0)
#define rb_set_color(rb, color) do { (rb)->rb_parent_color = ((rb)->rb_parent_color & ~1) | (color); } while (0)

extern void rb_init_node(struct rb_node *rb);
