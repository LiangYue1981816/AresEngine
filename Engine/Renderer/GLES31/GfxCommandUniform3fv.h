...
{
public:
	CGfxCommandUniform3fv(const char *szName, uint32_t count, const float *value)
...
public:
	...
	{
		CGfxProfilerSample(CGfxProfiler::SAMPLE_TYPE_COMMAND_UNIFORM3FV, "CommandUniform3fv");
		{
