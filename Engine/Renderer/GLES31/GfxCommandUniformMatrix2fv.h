...
{
public:
	CGfxCommandUniformMatrix2fv(const char *szName, uint32_t count, const float *value)
...
public:
	...
	{
		CGfxProfilerSample(CGfxProfiler::SAMPLE_TYPE_COMMAND_UNIFORMMATRIX2FV, "CommandUniformMatrix2fv");
		{
