	...
	, m_pTexture(nullptr)
{
	...
	if (CGfxHelper::IsFormatDepthOnly(format)) {
		...
		imageAspectFlags = VK_IMAGE_ASPECT_COLOR_BIT;
		imageUsageFlags = VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT | VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT | (bTransient ? VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT : VK_IMAGE_USAGE_TRANSFER_SRC_BIT) | VK_IMAGE_USAGE_STORAGE_BIT;
	}
