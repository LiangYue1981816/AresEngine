...
typedef enum GfxBufferType {
	GFX_BUFFER_INVALID_ENUM = -1,
	GFX_BUFFER_INDEX_BUFFER,
	GFX_BUFFER_VERTEX_BUFFER,
	GFX_BUFFER_UNIFORM_BUFFER,
	GFX_BUFFER_STORAGE_BUFFER,
	GFX_BUFFER_INSTANCE_BUFFER,
	GFX_BUFFER_INDIRECT_BUFFER,
	GFX_BUFFER_TRANSFER_BNUFER,
	GFX_BUFFER_TYPE_COUNT
} GfxBufferType;
