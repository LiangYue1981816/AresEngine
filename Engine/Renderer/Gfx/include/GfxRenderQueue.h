...
public:
	virtual void CmdDraw(int indexQueue, CGfxCommandBufferPtr ptrCommandBuffer, const CGfxDescriptorSetPtr ptrDescriptorSetPass, uint32_t matPassName, const glm::vec4& scissor, const glm::vec4& viewport);
