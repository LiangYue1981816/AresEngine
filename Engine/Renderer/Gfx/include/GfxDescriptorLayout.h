...
public:
	...
	virtual void SetStorageImageBinding(uint32_t name, uint32_t binding) = 0;
...
public:
	...
	virtual uint32_t GetStorageImageBinding(uint32_t name) const = 0;
...
public:
	...
	virtual bool IsStorageImageValid(uint32_t name) const = 0;
