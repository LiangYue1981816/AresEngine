...
public:
	...
	virtual CGfxTexture2DPtr NewTexture2D(const char *szFileName, uint32_t baseLevel = 0) = 0;
	...
	virtual CGfxTexture2DArrayPtr NewTexture2DArray(const char *szFileName, uint32_t baseLevel = 0) = 0;
	...
	virtual CGfxTextureCubeMapPtr NewTextureCubeMap(const char *szFileName, uint32_t baseLevel = 0) = 0;
	...
	virtual CGfxMaterialPtr NewMaterial(const char *szFileName, uint32_t vertexBinding = 0, uint32_t instanceBinding = 1, uint32_t baseLevel = 0) = 0;
