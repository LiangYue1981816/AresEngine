...
private:
	...
	CGLES3Texture2DArray* CreateTexture2DArray(uint32_t name, const char *szFileName);
	CGLES3Texture2DArray* CreateTexture2DArray(const char *szFileName);
	CGLES3TextureCubeMap* CreateTextureCubeMap(uint32_t name);
	CGLES3TextureCubeMap* CreateTextureCubeMap(uint32_t name, const char *szFileName);
