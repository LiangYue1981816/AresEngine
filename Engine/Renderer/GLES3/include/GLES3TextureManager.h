...
private:
	...
	CGLES3Texture2D* Create(const char* szFileName, uint32_t baseLevel);
...
private:
	...
	CGLES3Texture2DArray* Create(const char* szFileName, uint32_t baseLevel);
...
private:
	...
	CGLES3TextureCubeMap* Create(const char* szFileName, uint32_t baseLevel);
