...
{
public:
	CGLES3CommandUniform4f(const char *szName, float v0, float v1, float v2, float v3)
...
public:
	virtual void Execute(void) const
	{
		...
		{
			GLES3Renderer()->GetCurrentPipelineGraphics()->Uniform4f(m_name, m_v0, m_v1, m_v2, m_v3);
		}
	}
