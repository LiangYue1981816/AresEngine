...
{
public:
	CGLES3CommandUniform2iv(const char *szName, int count, const int *value)
...
public:
	virtual void Execute(void) const
	{
		...
		{
			GLES3Renderer()->GetCurrentPipelineGraphics()->Uniform2iv(m_name, m_value.size(), m_value.data());
		}
	}
