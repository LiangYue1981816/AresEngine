...
bool CResourceLoader::LoadTexture2D(const char *szFileName, CGfxTexture2D *pTexture2D)
{
	pTexture2D->Destroy();
	{
		do {
...
bool CResourceLoader::LoadTexture2DArray(const char *szFileName, CGfxTexture2DArray *pTexture2DArray)
{
...
bool CResourceLoader::LoadTexture2DArrayLayer(const char *szFileName, int layer, CGfxTexture2DArray *pTexture2DArray)
{
	do {
		CStream stream;
		if (FileManager()->LoadStream(szFileName, &stream) == false) break;
...
bool CResourceLoader::LoadTextureCubeMap(const char *szFileName, CGfxTextureCubeMap *pTextureCubeMap)
{
...
bool CResourceLoader::LoadTextureCubeMapFace(const char *szFileName, GfxTextureCubeMapFace face, CGfxTextureCubeMap *pTextureCubeMap)
{
	do {
		CStream stream;
		if (FileManager()->LoadStream(szFileName, &stream) == false) break;
