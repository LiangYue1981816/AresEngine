...
public:
	...
	virtual bool LoadMaterial(const char* szFileName, CGfxMaterial* pMaterial, uint32_t vertexBinding = 0, uint32_t instanceBinding = 1, int baseLevel = 0);
...
public:
	virtual CSceneNode* LoadSceneMesh(const char* szFileName, CSceneNode* pParentSceneNode, uint32_t instanceFormat, uint32_t vertexBinding = 0, uint32_t instanceBinding = 1, int baseLevel = 0);
