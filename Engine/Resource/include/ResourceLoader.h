...
public:
	virtual CSceneNode* LoadSceneMesh(const char* szFileName, CSceneNode* pParentSceneNode, int vertexBinding, int instanceBinding, int baseLevel = 0, int numLevels = INT_MAX);
