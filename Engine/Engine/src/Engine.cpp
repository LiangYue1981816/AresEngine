	...
	, m_taskGraphRender("TashGraph_Render")
{
	...
	m_pSettings->Register("RenderSystem.Shadow.Factor", "", 1.0f);
	m_pSettings->Register("RenderSystem.Shadow.SplitFactor0", "", exp(-4.0f));
	...
	m_pSettings->Register("RenderSystem.AutoExposure.Lower", "", 0.10f);
