...
//	float shadow = ShadowValueIrregular(inPosition, texShadow);
	...
	vec3 pointLighting = PBRLighting(worldNormal, worldViewDirection, pointLightDirection, pointLightColor, albedoColor, specular, metallic, roughness) * pointLightFactor;
	vec3 directLighting = PBRLighting(worldNormal, worldViewDirection, mainDirectLightDirection, mainDirectLightColor, albedoColor, specular, metallic, roughness) * directLightFactor;
#ifdef ENV_MAP
