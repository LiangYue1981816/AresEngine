...
void main()
{
	...
	mediump vec3 directLightingColor = PBRLightingFast(mainDirectLightColor, mainDirectLightDirection, inHalfDirection, inViewDirection, pixelNormal, albedoColor, metallic, roughness) * directLightFactor;
#ifdef ENV_MAP
